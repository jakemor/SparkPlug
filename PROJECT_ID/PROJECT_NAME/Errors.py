...
class BadRequestException(ECException):
...
class UnauthorizedException(ECException):
...
class ForbiddenException(ECException):
...
class NotFoundException(ECException):
...
class ClientException(ECException):
...
class InternalException(ECException):
